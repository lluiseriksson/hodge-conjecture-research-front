...
| stacky strict-support decomposition | B077 proves the pure proper pushdown from the smooth finite-stabilizer semistable stack is semisimple and decomposes by strict support | NG054: existence of the full-support summand does not force the specialized tube to project nontrivially to it; G043 is the class-level projection gate |
