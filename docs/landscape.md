...
| stacky detector descent | G040 asks for rational nearby cycles, strict support, invariant full-support pushdown, both B022 quotients, and nonzero Saito pairing on B071's semistable log-stack or an equivariant scheme realization | no audited theorem yet supplies this full comparison square; stabilizer-supported corrections and trace annihilation are explicit falsifiers |
