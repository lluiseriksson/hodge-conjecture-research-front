...
| auxiliary-detector cancellation | B106 proves c cancels from G069's inequality, leaving exactly B010, and restores B095/G059's exhaustive cokernel/evaluation certificate on the actual collision object | NG082: naming c in the discrepancy does not link the local relation to the global tube; G059 is the active provenance-preserving gate |
