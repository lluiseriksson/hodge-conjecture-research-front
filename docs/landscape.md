...
| equivariant resolution | B070 imports functorial absolute resolution and formally obtains finite-group equivariance; G039 asks for a relative toroidal refinement preserving weak semistability | NG048: resolving the abstract total variety does not preserve equidimensionality, saturation, reduced fibers, or nearby-cycle detector maps automatically |
