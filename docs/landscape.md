...
| universal strict-support gate | G023 asks whether every non-full-support wonderful direct-image summand begins in ordinary degree at least two | arbitrary nested normal fibers and shifts are unproved |
...
subgate. B049-B050 close its divisor and coefficient-sheaf inductions, and
G023 is the current strict-support brick.
