...
| Nori-Brogan incidence calculation | B130 places the primitive (r,r) component in H^(-d+1)gr_F^(-r)DR(M) with the exact universal-hyperplane indices | NG104: the ordinary local Betti sheaf vanishes on P_sm despite that Higgs cohomology; G087 must identify the map and prove discriminant-stalk survival |
