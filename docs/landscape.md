...
| special lift versus local relation | B092 gives identical type-(0,0) nearby/special exact data with either zero or nonzero maps to a relation line | NG068: invariant-cycle liftability does not select the local coordinate; G056 must construct and compute the geometric edge map |
