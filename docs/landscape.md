...
| iterated nearby-cycle comparison | B061 audits natural lax comparison and two conditional commutation theorems; G033 asks for a rational Hodge-compatible version preserving the detector pairing | NG042: commutation is false in general; B062 shows graph embedding retains the critical conormal obstruction, and no audited source supplies the rational MHM/pairing square |
