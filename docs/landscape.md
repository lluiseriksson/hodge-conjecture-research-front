...
| downstairs IC descent | B039 proves that the only extra strict-support summands under the blow-up are point-supported in ordinary degree two, so the downstairs degree-one IC stalk is B038's relation kernel | the rational Hodge type and propagation to general multipart arrangements remain open |
