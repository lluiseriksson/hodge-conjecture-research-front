...
| marked plane through a nodal target | B089 proves generic linear avoidance gives distinct local discriminant tangents while keeping a chosen smooth reference fiber fixed | NG065: the marked boundary loop need not carry a detector surviving B022 or pairing with the prescribed class; G053 is the class-specific replacement gate |
