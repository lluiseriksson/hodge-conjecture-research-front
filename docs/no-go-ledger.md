...
## NG-232 - Retain standard ranks 97–101 on \(Q^{14}\)

- **Label:** NO-GO
- **Route:** retain the G195 standard rank 97 or one of the next four
  integer layers on \(Q^{14}\).
- **Residual obstruction:** B259 specializes to \(Q^{12}\) and excludes
  all projected ranks 67–71.
- **Mixed obstruction:** ranks through 100 leave fewer than seven
  ...
  escape and a filled \(\mathbf P^8\) contact locus of rank 45.
...
## NG-235 - Retain standard rank 112 on \(Q^{16}\)

- **Label:** NO-GO
- **Route:** realize the sole standard \(d=16\) row of G198.
- **Residual obstruction:** the projected \(Q^{14}\) rank is at most 78,
  below B277's standard floor 108.
...
## NG-240 - Retain standard ranks 128 through 133 on \(Q^{18}\)

- **Label:** NO-GO
- **Route:** realize G203 at standard rank 128 or retain the branch
  through rank 133.
- **Residual obstruction:** projected \(Q^{16}\) ranks 90 through 95
  lie below the standard floor 119.
- **Mixed obstruction:** three minimal escapes use 39 dimensions; at
  most seven remain before a fourth escape of rank at least 11.
- **Boundary consequence:** G203 is NO-GO and G204 is active.
- **Detector guard:** no relation, ODP package, Kuranishi vanishing,
  rational detector, specified pairing, cycle, proof, or disproof of HC
  is produced.
...
## NG-242 - Retain standard ranks 160 and 161 on \(Q^{22}\)

- **Label:** NO-GO
- **Route:** realize G205 at standard rank 160 or retain rank 161.
- **Residual obstruction:** projected \(Q^{20}\) ranks 114 and 115 lie
  below the standard floor 148.
- **Mixed obstruction:** three minimal escapes use 51 dimensions; at
  most three remain before a fourth escape of rank at least 15.
- **Boundary consequence:** G205 is NO-GO and G206 is active.
- **Detector guard:** no relation, ODP package, Kuranishi vanishing,
  rational detector, specified pairing, cycle, proof, or disproof of HC
  is produced.
