...
1. Write the tangent map from the Hilbert/Chow deformation space of \(Z\) to
   the infinitesimal Hodge locus, with every smoothness/lci assumption explicit.
2. Separate semiregularity results that annihilate obstructions from statements
