...
codimension: construct the complete G144 package with delta_1=Y(d)-d-1 and an isomorphic degree-one relation transport at the valid B266/B273/B277/B278 cubic piecewise boundary
...
scope: relative
dependencies: B007-B010, B134-B278, G013, G090-G148, G172, NG106-NG234, S081-S084
claim: For every arbitrary primitive target, construct the complete G144 package at h_Z(1)=Y(d), delta_1=Y(d)-d-1, slack s_12(d)=2(Y(d)-d-1), and N=2Y(d), retaining every relation, ODP, Kuranishi, rational-type, and nonzero specified-pairing clause.
falsifier: one primitive target for which no polarization realizes the Y(d) package or a different boundary after the valid closure of G197
---

# G198 — Active cubic piecewise boundary
...
G198 must classify cubic/quartic equality at rank 104 on \(Q^{14}\),
