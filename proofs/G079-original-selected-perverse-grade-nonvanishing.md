...
codimension: middle cycle codimension n; the remaining competing point support has base codimension two and lies in a different perverse grade
coefficient_field: Q
...
dependencies: B057-B059, B081-B084, B110-B117, G047-G048, G073-G078, NG059-NG060, NG086-NG093, S052
...
the point-supported grade \(E_\infty^{0,-1}\). B117 proves that every
nonzero \(E_\infty^{-1,0}\) class in the original pushdown is already in
the full-support strict-support summand.

## Current obstruction

No topology-changing construction yet carries the distributed B057 chain
into the original nearby-cycle object with a nonzero relevant grade. The
semistable cover can help compute this map, but its exceptional support must
not be substituted for the original class. G073-G075 retain the source and
descent obligations.
