...
dimension: dim X=d=2n; m=2; slack s=6d+8=12n+8; N=8d+10=16n+10; h_Z(1)=4d+5=8n+5=N/2
codimension: construct the complete G144 package with delta_1=3d+4 and an isomorphic degree-one relation transport at the first balanced rank above B247's nonstandard boundary exclusion
...
claim: For every arbitrary primitive target (X,zeta) of dimension d=2n, choose a very ample A and construct H=A^2 plus a reduced Z of N=8d+10 points satisfying the complete G144 package with slack s=6d+8, h_Z(1)=4d+5, an isomorphic full-support relation transport, a diagonally self-dual degree-one code, every ODP-profile, holonomy and finite-Kuranishi clause, rational type (0,0), and nonzero specified pairing.
falsifier: one primitive target for which no choice of A realizes the one-beyond-nonstandard balanced code together with every geometric, rationality, Hodge-type, and pairing obligation
---

# G171 — Move one rank beyond the nonstandard boundary

B247 closes G170 and the adjacent odd layer. The next balanced
signature is

\[
 m=2,\qquad s=6d+8,\qquad \delta_1=3d+4, \tag{1}
\]

with

\[
 N=8d+10,\qquad h_Z(1)=4d+5=N/2,\qquad
 s-2\delta_1=0. \tag{2}
\]

B248 excludes this rank on a sufficiently large even quadric; the
explicit threshold from its uniform argument is \(Q^{124}\). More
strongly, B248 excludes every continuation with dimension-independent
additive excess. Thus G171 is NO-GO (NG206), and the next justified gate
is G172 with excess growing along the quadric dimensions.
