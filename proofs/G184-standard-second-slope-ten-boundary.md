...
dimension: dim X=d=2n; m=2; slack s=10d-14=20n-14; N=12d-12=24n-12; h_Z(1)=6d-6=12n-6=N/2
codimension: construct the complete G144 package with delta_1=5d-7 and an isomorphic degree-one relation transport one rank above B257's standard boundary
...
B257 raises the common quadric floor to

\[
 m=2,\qquad s=10d-14,\qquad \delta_1=5d-7,\qquad
 N=12d-12,\qquad h_Z(1)=6d-6=N/2. \tag{1}
\]

On every even quadric of dimension at least fourteen, B254-B256 exclude
