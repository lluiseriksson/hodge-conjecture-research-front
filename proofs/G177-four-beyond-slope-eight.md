...
dimension: dim X=d=2n; m=2; slack s=8d; N=10d+2; h_Z(1)=5d+1=N/2
codimension: construct the complete G144 package with delta_1=4d and an isomorphic degree-one relation transport four ranks beyond B250's excluded slope-eight equality
...
claim: For every arbitrary primitive target (X,zeta), construct the complete G144 package at m=2, slack s=8d, delta_1=4d, N=10d+2, and h_Z(1)=5d+1=N/2.
falsifier: the valid even-quadric input on which B249 and B253 exclude every polarization at this rank
---

# G177 — Four ranks beyond slope-eight equality

B253 excludes the standard polarization at \(h_Z(1)=5d+1\), while
B249 excludes the square and every higher polarization. Hence G177 and
the adjacent odd layer \(s=8d+1\) are NO-GO on valid even quadrics
\(Q^d\), \(d\ge10\).

This is only a necessary special-input obstruction. It constructs no
marked scheme, ODP package, rational detector, specified pairing,
