...
dependencies: B007, B010, B026-B028, B054, B128, B134-B146, and NG103
...
B146 adds the first nonlinear compatibility condition: every value relation
must annihilate the critical-value Hessian on conditional gradients. For a
uniform value matroid this forces gradient corank at least \(n(R+1)\).
G092 asks for that isotropic degeneracy and its higher-order integration;
NG117 excludes a bare value-rank determinantal locus.
