...
falsifier: one primitive target for which no polarization realizes the piecewise package; on even quadrics B263 leaves k=2 for d=14,16,18,20, k=1,3,4 for d=22, and k=3,4 for even d>=24
---
