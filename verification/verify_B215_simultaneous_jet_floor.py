...
def main():
    ...
    # Remainder two uses one double neighborhood, not two simple points.
    assert lower_rank(dimension_x, 4) == second_jet_length + dimension_x + 1
    ...
    # Mixed interpolation: degree k=11 has q=4 triples and no residual jet.
