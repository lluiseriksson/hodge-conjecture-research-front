...
fill the span. B239 nevertheless excludes every polarization. Six
hyperplane factors separate the fifth point for \(O_Q(k\ge3)\). Under
\(O_Q(2)\), the sole residual base line has a nonzero transverse quartic
jet. Under \(O_Q(1)\), quotient ranks handle \(d\ge6\), while an exact
self-adjoint calculation on \(Q^4\) confines the contact locus to one
plane conic and one point. Thus G162 and \(4d+7\) are **NO-GO** (NG197),
and
...
Hence G168 and the odd layer \(6d+1\) are **NO-GO** (NG203). The next
gate was G169:
...
B278 audits the apparent \(d\ge22\) threshold in B269/B271/B272 and
shows it came only from the old survivor table. Their plane/conormal,
weak-del-Pezzo, eighth-point, and transverse-octic arguments work for
every even \(d\ge14\). Consequently cubic and quartic rank
\(7d+5=103\) both fail on \(Q^{14}\). NG234 makes G197 **NO-GO** and
