...
standard rational Hodge Conjecture
  ...
  <=> nonempty codimension-two local support                     [B012/G008]
      <= class-paired multipart nodal incidence                  [B026-B055/G028]
      <= topology-changing tube-to-nodal transport               [G029, OPEN]
...
The active attackable gate is **G029**, a topology-changing specialization
from a chosen global tube or quotient-level thimble detector to one clean
multipart nodal relation while preserving rational Hodge type and the
specified nonzero pairing. G014 remains a sufficient unanchored
