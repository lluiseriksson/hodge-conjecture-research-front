...
The active attackable gate is **G030**, a class-preserving collision of a
specific detector loop inside a generic projective plane net to one clean
multipart nodal relation. The specialization must preserve the exact
primitive ambient class and rational Hodge type. G014 remains a sufficient unanchored
