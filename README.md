...
The active gate is **G007**. B011 gives a global monodromy tube detecting an
arbitrary primitive class, while B010 gives the exact local
vanishing-relation pairing criterion. The task is to concentrate the global
tube cancellation at one higher discriminant stratum, preserving rational
Hodge type and the nonzero pairing. B008 shows why a generic filling through
separate smooth discriminant points cannot suffice. This concentration
theorem is not known and is terminal-equivalent after universal
quantification.
